        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumBalanceForProduct = table.Column<int>(type: "int", nullable: false),
                    ClosureStatus = table.Column<int>(type: "int", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateOfLastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DebitAccount = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreditAccount = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountBalance = table.Column<decimal>(type: "decimal(25,2)", precision: 25, scale: 2, nullable: false),
                    AccountClosureDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ClosureStatus = table.Column<int>(type: "int", nullable: false),
                    AccountStatus = table.Column<int>(type: "int", nullable: false),
                    LastTransactionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReactivationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
